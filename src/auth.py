...
USERS_DB = {
    ...
    "innovation@ubl": {
        ...
        "hashed_password": hash_password("innovation@ubl-#123$"),
        "role": "admin-ubl",
        "disabled": False,
    },
    "ibtisam@ubl": {
        "username": "ibtisam@ubl",
        "hashed_password": hash_password("ibtisam@ubl-#123$"),
        "role": "admin-ubl",
        "disabled": False,
    },
    "innovation-ops@ubl": {
        "username": "innovation-ops@ubl",
        "hashed_password": hash_password("innovation-ops@ubl-#123$"),
        "role": "admin-ubl",
        "disabled": False,
    },
    "rafay@ubl": {
        "username": "rafay@ubl",
        "hashed_password": hash_password("rafay@ubl-#123$"),
        "role": "admin-ubl",
        "disabled": False,
    },
    "innovation1@ubl": {
        "username": "innovation1@ubl",
        "hashed_password": hash_password("innovation1@ubl-#123$"),
        "role": "admin-ubl",
        "disabled": False,
    },
}
